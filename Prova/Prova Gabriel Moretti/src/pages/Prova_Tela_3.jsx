...
function Prova_Tela_3() {
    const { setAutor, nome } = useContext(PrincipalContext);
    ...
    return (
        <div>
            ...
            <div className={estilo.principal}>
                ...
                <div  className={estilo.titulo}>Informe o autor do seu resumo</div>
                <input type="text" onChange={(e) => setAutor(e.target.value)}/>

                <button><Link to="/prova_Tela_4">Próximo</Link></button>
